...
[![Build Status](https://builds.gbif.org/job/hp-luxembourg/badge/icon)](https://builds.gbif.org/job/hp-luxembourg/lastBuild/console)
...
# GBIF Hosted Portal: Biodiversiteit.lu

This Jekyll website, **[luxembourg (Staging)](https://luxembourg.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
